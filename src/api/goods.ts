          ...
          list.map((o) => {
            ...
            data.push({
              ...
              curriculum_start_time:
                curriculumDatetimeParse && curriculumDatetimeParse[0] && curriculumDatetimeParse[0].slice(0, 10),
              curriculum_end_time:
                curriculumDatetimeParse && curriculumDatetimeParse[1] && curriculumDatetimeParse[1].slice(0, 10),
            })
          })
          resolve(data)
        } else {
        ...
        if (r.code === 0) {
          ...
          const normalizeGoodsInfo = (d) => {
            ...
            const data: goodsType = {
              ...
              price_member_min: d.price_member_min,
              price_member_max: d.price_member_max,
              level_show: d.level_show,
              ...
              curriculum_start_time: d.curriculum_datetime[0] && d.curriculum_datetime[0].slice(0, 10),
              curriculum_end_time: d.curriculum_datetime[1] && d.curriculum_datetime[1].slice(0, 10),
